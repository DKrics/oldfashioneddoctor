...
Keeper `2026-09-11 01:56 CDT`: https://dkrics.github.io/oldfashioneddoctor/ serves Astro (cream/amber, covers, Drinks). Apex `oldfashioneddoctor.com` still Blogger A records `216.239.*`. Cusdis.com HTTP **521**. No Squarespace/Google session on the box browser. GitHub Pages `cname` null (preview mode).
